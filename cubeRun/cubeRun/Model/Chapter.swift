...
class Chapter {
    ...
    private let chapterDifficulty: [Int:Difficulty] = [
        ...
        3: Difficulty(maxInterval: 1, maxHoldNum: 1, maxHoldBeat: 1, holdChance: 4/10),
        ...
        11: Difficulty(maxInterval: 1, maxHoldNum: 1, maxHoldBeat: 1, holdChance: 4/10),
        12: Difficulty(maxInterval: 1, maxHoldNum: 1, maxHoldBeat: 1, holdChance: 4/10)
    ]
